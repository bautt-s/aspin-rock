    ...
    return (
        <div className="flex flex-col px-[40px] lg:px-[80px] py-[80px]">
            <div className="flex flex-col-reverse xl:flex-row items-center justify-center gap-x-[60px]">
                ...
                <img src={institutionalVision} className='mx-auto xl:mr-0 xl:ml-auto mb-[25px] object-cover' height='600' width='700' />
            </div>
            ...
            <div className='flex flex-col mt-[60px]' id='learn-more'>
                ...
                <form className='flex flex-col mt-[40px]'>
                    ...
                    <div className='flex flex-col md:flex-row md:items-center mt-[40px] gap-x-[40px]'>
                        ...
                        <button onClick={() => scrollToSection()}
                        className='md:ml-auto bg-black hover:bg-[#131313] text-white px-[25px] py-[10px] transition-colors duration-300 mt-[40px] w-fit'>
                            Submit
                        </button>
                    </div>
                </form>
