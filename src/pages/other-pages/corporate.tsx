...
const heroImg = require('../../static/hero-corporate.png')
const corpImg1 = require('../../static/corporate-1.png')
const corpImg2 = require('../../static/corporate-2.png')
const corpImg3 = require('../../static/corporate-3.png')
            ...
            <div className='w-full'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col-reverse lg:flex-row bg-black px-[40px] lg:px-[80px] lg:items-center py-[80px] lg:gap-x-[60px] 2xl:gap-x-0'>
                        ...
                        <img src={heroImg} className='lg:ml-auto md:h-[300px] lg:h-[500px] lg:w-[400px] 
                    ...
                    <div className='pt-[40px] px-[40px] lg:px-[80px] pb-[240px]'>
                        ...
                        <div className='flex flex-col mt-[45px] gap-y-[80px] xl:gap-y-[25px]'>
                            <div className='flex flex-col xl:flex-row xl:items-center gap-x-[120px]'>
                                <img src={corpImg1} className='w-[600px] 2xl:w-[700px] h-[400px] object-cover' />
                            ...
                            <div className='flex flex-col xl:flex-row xl:items-center gap-x-[120px]'>
                                <img src={corpImg2} className='lg:w-[600px] 2xl:w-[700px] h-[400px] object-cover' />
                            ...
                            <div className='flex flex-col xl:flex-row xl:items-center gap-x-[120px]'>
                                <img src={corpImg3} className='w-[600px] 2xl:w-[700px] h-[400px] object-cover' />
