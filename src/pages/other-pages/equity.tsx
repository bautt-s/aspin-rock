...
const equityHero = require('../../static/equity-hero.png')
const equityImg = require('../../static/equity-img.png')
    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="w-full flex flex-col">
                <img src={equityHero} className="object-cover max-h-[600px]" />
                ...
                <div className="mt-[80px] flex flex-col items-center px-[40px] lg:px-[80px]">
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-x-[120px] mt-[120px] pb-[80px]">
                        ...
                        <img src={equityImg} className="h-[400px] sm:h-[200px] sm:w-[800px] lg:h-auto 
